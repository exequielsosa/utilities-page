...
import { isValidCBUorCVU, onlyDigits, format22, guessType22 } from "@/lib/cbu";

export const CbuScreen = () => {
      ...
      >
        ...
        {clean.length === 22 && (
          ...
          >
            ...
            <span style={{ color: "var(--text-secondary)" }}>Tipo: {kind}</span>
            {validity && (
              <button
